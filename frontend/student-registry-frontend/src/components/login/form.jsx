        ...
        <div className="mt-8 flex flex-col gap-y-4">
          ...
          <button className="flex py-3 border-2 border-gray-100 items-center justify-center gap-2 active:scale-[.98] active:duration-75 hover:scale-[1.01] rounded-xl ease-in-out transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48">
              ...
              <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571c0.001-0.001,0.002-0.001,0.003-0.002L34.658,26.14C37.342,24.059,39.092,21.549,41.019,18.538c0.558-0.849,1.186-1.632,1.892-2.375C43.237,18.16,43.611,19.039,43.611,20.083z"></path>
            </svg>
