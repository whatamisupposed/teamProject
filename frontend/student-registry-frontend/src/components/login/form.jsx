...
function Form() {
    ...
    return (
      <div className="bg-white px-10 py-20 rounded-3xl shadow-xl">
        ...
        <p className="font-medium text-lg textgray-500 mt-4">Welcome back! Please Enter your details.</p>
        <div className="mt-8">
            <div>
            ...
            <div className="mt-8 flex flex-col gap-y-4">
                <button className="active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-3 rounded-xl bg-blue-600 text-white text-lg font-bold">Sign in</button>
