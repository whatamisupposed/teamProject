    ...
    return (
      <div className="flex flex-col justify-between h-screen bg-blue-600 w-24 items-center">
        <div className="flex flex-col justify-center w-24">
            ...
            <div className="flex flex-col py-4 items-center w-full hover:bg-blue-700 active:bg-white">
                <CgProfile size={45} />
                <p>Account</p>
            </div>
            <div className="flex flex-col py-4 items-center w-full hover:bg-blue-700">
